<%@ Page Title="Log In" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LogInPage.aspx.cs" Inherits="QuoteGenUS.LogInPage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="UsernameInvalidLabel" runat="server" Visible="false" Text="| INVALID USERNAME"  Font-Size="12pt" ForeColor="Red"></asp:Label>
    <br />
    ...
    <asp:Label ID="PasswordInvalidLabel" runat="server" Visible="false" Text="| INVALID PASSWORD"  Font-Size="12pt" ForeColor="Red"></asp:Label>
    <br />
